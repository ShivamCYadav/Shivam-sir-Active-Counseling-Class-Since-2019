const quizzes = {
    bhagwatGeeta: [
        { question: "भगवद गीता का प्रारंभ कहां होता है?", options: ["A) हस्तिनापुर", "B) द्वारका", "C) कुरुक्षेत्र", "D) वृंदावन"], answer: "C) कुरुक्षेत्र" },
        { question: "भगवद गीता के कितने अध्याय हैं?", options: ["A) 16", "B) 18", "C) 20", "D) 24"], answer: "B) 18" },
        { question: "भगवद गीता का उपदेश किसने दिया?", options: ["A) अर्जुन", "B) भीष्म", "C) द्रोणाचार्य", "D) श्रीकृष्ण"], answer: "D) श्रीकृष्ण" },
        { question: "भगवद गीता किस महाकाव्य का हिस्सा है?", options: ["A) रामायण", "B) महाभारत", "C) उपनिषद", "D) पुराण"], answer: "B) महाभारत" },
        { question: "भगवद गीता का उपदेश किसे दिया गया?", options: ["A) युधिष्ठिर", "B) भीम", "C) अर्जुन", "D) नकुल"], answer: "C) अर्जुन" },
        { question: "कृष्ण ने अर्जुन को भगवद गीता का उपदेश कब दिया?", options: ["A) युद्ध के बाद", "B) युद्ध के पहले", "C) युद्ध के दौरान", "D) युद्ध के बीच"], answer: "C) युद्ध के दौरान" },
        { question: "भगवद गीता का मुख्य विषय क्या है?", options: ["A) धर्म", "B) कर्म", "C) भक्ति", "D) मोक्ष"], answer: "B) कर्म" },
        { question: "भगवद गीता में कितने श्लोक हैं?", options: ["A) 500", "B) 600", "C) 700", "D) 800"], answer: "C) 700" },
        { question: "भगवद गीता का दूसरा नाम क्या है?", options: ["A) उपनिषद", "B) संहिता", "C) गीता", "D) वचनामृत"], answer: "C) गीता" },
        { question: "भगवद गीता का पहला अध्याय क्या कहलाता है?", options: ["A) अर्जुनविषाद योग", "B) सांख्य योग", "C) कर्म योग", "D) भक्ति योग"], answer: "A) अर्जुनविषाद योग" },
        { question: "भगवद गीता के अनुसार, आत्मा क्या है?", options: ["A) नश्वर", "B) अमर", "C) परिवर्तनशील", "D) अज्ञात"], answer: "B) अमर" },
        { question: "भगवद गीता में भगवान कृष्ण ने किसे अपना विश्वरूप दिखाया?", options: ["A) युधिष्ठिर", "B) भीम", "C) अर्जुन", "D) दुर्योधन"], answer: "C) अर्जुन" },
        { question: "भगवद गीता का कर्म योग किस अध्याय में है?", options: ["A) दूसरा", "B) तीसरा", "C) चौथा", "D) पाँचवाँ"], answer: "B) तीसरा" },
        { question: "भगवद गीता में भक्ति योग का वर्णन किस अध्याय में है?", options: ["A) नौवाँ", "B) दसवाँ", "C) ग्यारहवाँ", "D) बारहवाँ"], answer: "D) बारहवाँ" },
        { question: "भगवद गीता में किस प्रकार के योग का वर्णन नहीं किया गया है?", options: ["A) भक्ति योग", "B) कर्म योग", "C) ज्ञान योग", "D) लय योग"], answer: "D) लय योग" },
        { question: "भगवद गीता में अर्जुन का सारथी कौन था?", options: ["A) युधिष्ठिर", "B) भीम", "C) श्रीकृष्ण", "D) कर्ण"], answer: "C) श्रीकृष्ण" },
        { question: "भगवद गीता के किस अध्याय में भगवान कृष्ण ने 'सर्व धर्मान परित्यज्य' का उपदेश दिया?", options: ["A) सत्रहवाँ", "B) अठारहवाँ", "C) पंद्रहवाँ", "D) चौदहवाँ"], answer: "B) अठारहवाँ" },
        { question: "भगवद गीता में 'योगस्थ: कुरु कर्माणि' का अर्थ क्या है?", options: ["A) बिना किसी अपेक्षा के कर्म करो", "B) धर्म का पालन करो", "C) भक्ति करो", "D) ज्ञान का अभ्यास करो"], answer: "A) बिना किसी अपेक्षा के कर्म करो" },
        { question: "भगवद गीता के अनुसार, सच्चा योगी कौन है?", options: ["A) जो केवल ध्यान करता है", "B) जो केवल ज्ञान प्राप्त करता है", "C) जो निष्काम कर्म करता है", "D) जो भक्ति करता है"], answer: "C) जो निष्काम कर्म करता है" },
        { question: "भगवद गीता में भगवान कृष्ण ने अर्जुन को क्या सिखाया?", options: ["A) युद्ध से बचना", "B) शांति स्थापित करना", "C) धर्म के लिए लड़ना", "D) ध्यान करना"], answer: "C) धर्म के लिए लड़ना" },
        { question: "भगवद गीता में अर्जुन के मनोबल को किसने बढ़ाया?", options: ["A) युधिष्ठिर", "B) भीम", "C) श्रीकृष्ण", "D) द्रोणाचार्य"], answer: "C) श्रीकृष्ण" },
        { question: "भगवद गीता में भगवान कृष्ण ने अर्जुन को कौन सा योग सिखाया?", options: ["A) भक्ति योग", "B) कर्म योग", "C) ज्ञान योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता का ज्ञान अर्जुन को कब दिया गया?", options: ["A) युद्ध के पहले", "B) युद्ध के दौरान", "C) युद्ध के बाद", "D) युद्ध के बीच"], answer: "B) युद्ध के दौरान" },
        { question: "भगवद गीता में भगवान कृष्ण ने अर्जुन को किस प्रकार के कर्म का पालन करने को कहा?", options: ["A) सकाम कर्म", "B) निष्काम कर्म", "C) अकर्म", "D) विकर्म"], answer: "B) निष्काम कर्म" },
        { question: "भगवद गीता में भगवान कृष्ण ने अर्जुन को किस प्रकार के योग का पालन करने को कहा?", options: ["A) भक्ति योग", "B) ज्ञान योग", "C) कर्म योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता के अनुसार, सच्चे योगी का कौन सा गुण प्रमुख है?", options: ["A) अहंकार", "B) समत्व", "C) क्रोध", "D) मोह"], answer: "B) समत्व" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का ज्ञान सर्वश्रेष्ठ है?", options: ["A) लौकिक ज्ञान", "B) वेद ज्ञान", "C) आत्मज्ञान", "D) वैज्ञानिक ज्ञान"], answer: "C) आत्मज्ञान" },
        { question: "भगवद गीता में अर्जुन को भगवान कृष्ण ने किस प्रकार का आत्मसंयम सिखाया?", options: ["A) इन्द्रिय संयम", "B) मन संयम", "C) अहंकार संयम", "D) सभी प्रकार का संयम"], answer: "D) सभी प्रकार का संयम" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार की भक्ति को सर्वोपरि बताया?", options: ["A) साकार भक्ति", "B) निराकार भक्ति", "C) साकार और निराकार दोनों", "D) कर्मयोगी भक्ति"], answer: "C) साकार और निराकार दोनों" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का कर्म श्रेष्ठ है?", options: ["A) परोपकार", "B) स्वधर्म", "C) परधर्म", "D) अन्याय"], answer: "B) स्वधर्म" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के व्यक्ति को परमात्मा के समीप बताया?", options: ["A) ज्ञानी", "B) भक्त", "C) कर्मयोगी", "D) सभी"], answer: "D) सभी" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार का युद्ध बताया?", options: ["A) धर्मयुद्ध", "B) रणयुद्ध", "C) कलियुद्ध", "D) अहिंसक युद्ध"], answer: "A) धर्मयुद्ध" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का व्यक्ति सच्चा योगी होता है?", options: ["A) जो केवल भक्ति करता है", "B) जो केवल ध्यान करता है", "C) जो निष्काम कर्म करता है", "D) जो केवल ज्ञान प्राप्त करता है"], answer: "C) जो निष्काम कर्म करता है" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का ज्ञान सबसे श्रेष्ठ है?", options: ["A) लौकिक ज्ञान", "B) आत्मज्ञान", "C) वेद ज्ञान", "D) वैज्ञानिक ज्ञान"], answer: "B) आत्मज्ञान" },
        { question: "भगवद गीता में किस प्रकार का योग सर्वोपरि बताया गया है?", options: ["A) कर्म योग", "B) भक्ति योग", "C) ज्ञान योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के व्यक्ति को सच्चा योगी बताया?", options: ["A) जो केवल भक्ति करता है", "B) जो केवल ध्यान करता है", "C) जो निष्काम कर्म करता है", "D) जो केवल ज्ञान प्राप्त करता है"], answer: "C) जो निष्काम कर्म करता है" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का व्यक्ति सच्चा ज्ञानी होता है?", options: ["A) जो केवल पढ़ता है", "B) जो केवल सुनता है", "C) जो अनुभव करता है", "D) जो केवल लिखता है"], answer: "C) जो अनुभव करता है" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के योग का महत्व बताया?", options: ["A) कर्म योग", "B) भक्ति योग", "C) ज्ञान योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के व्यक्ति को सच्चा ज्ञानी बताया?", options: ["A) जो केवल पढ़ता है", "B) जो केवल सुनता है", "C) जो अनुभव करता है", "D) जो केवल लिखता है"], answer: "C) जो अनुभव करता है" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के योग का पालन करने को कहा?", options: ["A) भक्ति योग", "B) ज्ञान योग", "C) कर्म योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के व्यक्ति को सच्चा योगी बताया?", options: ["A) जो केवल भक्ति करता है", "B) जो केवल ध्यान करता है", "C) जो निष्काम कर्म करता है", "D) जो केवल ज्ञान प्राप्त करता है"], answer: "C) जो निष्काम कर्म करता है" },
        { question: "भगवद गीता के अनुसार, किस प्रकार का ज्ञान सबसे श्रेष्ठ है?", options: ["A) लौकिक ज्ञान", "B) आत्मज्ञान", "C) वेद ज्ञान", "D) वैज्ञानिक ज्ञान"], answer: "B) आत्मज्ञान" },
        { question: "भगवद गीता में किस प्रकार का योग सर्वोपरि बताया गया है?", options: ["A) कर्म योग", "B) भक्ति योग", "C) ज्ञान योग", "D) सभी योग"], answer: "D) सभी योग" },
        { question: "भगवद गीता में भगवान कृष्ण ने किस प्रकार के व्यक्ति को सच्चा योगी बताया?", options: ["A) जो केवल भक्ति करता है", "B) जो केवल ध्यान करता है", "C) जो निष्काम कर्म करता है", "D) जो केवल ज्ञान प्राप्त करता है"], answer: "C) जो निष्काम कर्म करता है" },

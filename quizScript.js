const quizzes = {
    ramayan: [
        { question: "रामायण के रचयिता कौन हैं?", options: ["A) वेदव्यास", "B) वाल्मीकि", "C) तुलसीदास", "D) नारद"], answer: "B) वाल्मीकि" },
        { question: "राम के पिता का नाम क्या था?", options: ["A) दशरथ", "B) जनक", "C) दशानन", "D) वसिष्ठ"], answer: "A) दशरथ" },
        { question: "राम की पत्नी का नाम क्या था?", options: ["A) मंदोदरी", "B) कैकेयी", "C) सीता", "D) उर्मिला"], answer: "C) सीता" },
        { question: "राम के भाई का नाम क्या था?", options: ["A) भरत", "B) लक्ष्मण", "C) शत्रुघ्न", "D) सभी"], answer: "D) सभी" },
        { question: "रामायण के अनुसार, रावण का निवास स्थान कहाँ था?", options: ["A) अयोध्या", "B) लंका", "C) मथुरा", "D) द्वारका"], answer: "B) लंका" },
        { question: "राम के गुरु कौन थे?", options: ["A) वशिष्ठ", "B) विश्वामित्र", "C) नारद", "D) अगस्त्य"], answer: "B) विश्वामित्र" },
        { question: "हनुमान किसके पुत्र थे?", options: ["A) वायु", "B) अग्नि", "C) इंद्र", "D) वरुण"], answer: "A) वायु" },
        { question: "राम का वनवास कितने वर्षों का था?", options: ["A) 10 वर्ष", "B) 12 वर्ष", "C) 14 वर्ष", "D) 16 वर्ष"], answer: "C) 14 वर्ष" },
        { question: "रामायण के अनुसार, सीता का हरण किसने किया?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) रावण", "D) विभीषण"], answer: "C) रावण" },
        { question: "रामायण में किस चरित्र को 'पवनपुत्र' कहा जाता है?", options: ["A) राम", "B) लक्ष्मण", "C) भरत", "D) हनुमान"], answer: "D) हनुमान" },
        { question: "सीता का जन्मस्थान कौन सा था?", options: ["A) अयोध्या", "B) मिथिला", "C) किष्किन्धा", "D) लंका"], answer: "B) मिथिला" },
        { question: "हनुमान ने संजीवनी बूटी किसके लिए लाई थी?", options: ["A) राम", "B) लक्ष्मण", "C) भरत", "D) शत्रुघ्न"], answer: "B) लक्ष्मण" },
        { question: "रामायण में किष्किन्धा नगरी किसकी राजधानी थी?", options: ["A) बाली", "B) सुग्रीव", "C) विभीषण", "D) अंगद"], answer: "B) सुग्रीव" },
        { question: "राम के कुलगुरु कौन थे?", options: ["A) वशिष्ठ", "B) विश्वामित्र", "C) वाल्मीकि", "D) अगस्त्य"], answer: "A) वशिष्ठ" },
        { question: "रामायण में लंका का राजा कौन था?", options: ["A) कुम्भकर्ण", "B) रावण", "C) विभीषण", "D) मेघनाथ"], answer: "B) रावण" },
        { question: "राम के वनवास का कारण कौन थी?", options: ["A) कौशल्या", "B) कैकेयी", "C) सुमित्रा", "D) मंदोदरी"], answer: "B) कैकेयी" },
        { question: "रामायण के अनुसार, लक्ष्मण की पत्नी का नाम क्या था?", options: ["A) उर्मिला", "B) सुलोचना", "C) तारा", "D) त्रिजटा"], answer: "A) उर्मिला" },
        { question: "रामायण में रावण के पुत्र का नाम क्या था?", options: ["A) मेघनाथ", "B) अक्षयकुमार", "C) इंद्रजीत", "D) बाली"], answer: "C) इंद्रजीत" },
        { question: "रामायण में शबरी किसकी भक्त थीं?", options: ["A) राम", "B) रावण", "C) सीता", "D) हनुमान"], answer: "A) राम" },
        { question: "रामायण में जटायु का संबंध किससे है?", options: ["A) एक ऋषि", "B) एक बंदर", "C) एक पक्षी", "D) एक राक्षस"], answer: "C) एक पक्षी" },
        { question: "रामायण के अनुसार, हनुमान ने किस पर्वत को उठाया था?", options: ["A) हिमालय", "B) गंधमादन", "C) ऋष्यमूक", "D) संजीवनी"], answer: "D) संजीवनी" },
        { question: "रामायण में सीता की अग्निपरीक्षा कहाँ हुई थी?", options: ["A) अयोध्या", "B) पंचवटी", "C) लंका", "D) चित्रकूट"], answer: "C) लंका" },
        { question: "रामायण में विभीषण किसके भाई थे?", options: ["A) कुम्भकर्ण", "B) रावण", "C) सुग्रीव", "D) अंगद"], answer: "B) रावण" },
        { question: "रामायण में लक्ष्मण को किसने मूर्छित किया था?", options: ["A) मेघनाथ", "B) रावण", "C) कुम्भकर्ण", "D) विभीषण"], answer: "A) मेघनाथ" },
        { question: "रामायण में किसने राम को उनके सच्चे स्वरूप का ज्ञान कराया था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) अंजना"], answer: "C) विभीषण" },
        { question: "रामायण के अनुसार, राम ने किसके साथ मित्रता की थी?", options: ["A) बाली", "B) सुग्रीव", "C) रावण", "D) विभीषण"], answer: "B) सुग्रीव" },
        { question: "रामायण में सीता का स्वयंवर किसने आयोजित किया था?", options: ["A) दशरथ", "B) जनक", "C) विश्वामित्र", "D) रावण"], answer: "B) जनक" },
        { question: "रामायण में किसने सीता की खोज की थी?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) सुग्रीव"], answer: "C) हनुमान" },
        { question: "रामायण में किसने राम को वनवास का आदेश दिया था?", options: ["A) दशरथ", "B) कौशल्या", "C) सुमित्रा", "D) कैकेयी"], answer: "D) कैकेयी" },
        { question: "रामायण में राम के वनवास के समय किसने उनकी सहायता की थी?", options: ["A) भरत", "B) लक्ष्मण", "C) शत्रुघ्न", "D) जनक"], answer: "B) लक्ष्मण" },
        { question: "रामायण में रावण के वध के बाद किसने लंका का राज्य संभाला?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) अंगद"], answer: "C) विभीषण" },
        { question: "रामायण में किसने राम को शिव धनुष भंग करने की चुनौती दी थी?", options: ["A) जनक", "B) परशुराम", "C) विश्वामित्र", "D) वशिष्ठ"], answer: "B) परशुराम" },
        { question: "रामायण में राम का जन्म किस राजा के घर हुआ था?", options: ["A) दशरथ", "B) जनक", "C) सुग्रीव", "D) रावण"], answer: "A) दशरथ" },
        { question: "रामायण में राम के वनवास का किसने विरोध किया था?", options: ["A) लक्ष्मण", "B) भरत", "C) शत्रुघ्न", "D) सभी"], answer: "D) सभी" },
        { question: "रामायण में किसने सीता को रावण की लंका में पाया था?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) विभीषण"], answer: "C) हनुमान" },
        { question: "रामायण में किसने सीता को अशोक वाटिका में देखा था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) कुम्भकर्ण"], answer: "A) हनुमान" },
        { question: "रामायण में किसने समुद्र पर सेतु बांधा था?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) नल-नील"], answer: "D) नल-नील" },
        { question: "रामायण में किसने राम को उनकी ईश्वरीय शक्ति का स्मरण कराया था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) अंजना"], answer: "C) विभीषण" },
        { question: "रामायण में किसने रावण की नाभि में अमृत होने की बात बताई थी?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) मंदोदरी"], answer: "C) विभीषण" },
        { question: "रामायण में राम के वनवास की अवधि कितनी थी?", options: ["A) 10 वर्ष", "B) 12 वर्ष", "C) 14 वर्ष", "D) 16 वर्ष"], answer: "C) 14 वर्ष" },
        { question: "रामायण में राम ने रावण का वध किस युद्ध में किया?", options: ["A) लंका युद्ध", "B) कुरुक्षेत्र युद्ध", "C) महाभारत युद्ध", "D) त्रेतायुग युद्ध"], answer: "A) लंका युद्ध" },
        { question: "रामायण में किसने राम को वानर सेना प्रदान की थी?", options: ["A) बाली", "B) सुग्रीव", "C) विभीषण", "D) अंगद"], answer: "B) सुग्रीव" },
        { question: "रामायण में किसने रावण का अंत किया था?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) विभीषण"], answer: "A) राम" },
        { question: "रामायण में किसने राम को वनवास के बाद राज्याभिषेक किया था?", options: ["A) दशरथ", "B) भरत", "C) लक्ष्मण", "D) हनुमान"], answer: "B) भरत" },
        { question: "रामायण में राम का सबसे छोटा भाई कौन था?", options: ["A) भरत", "B) लक्ष्मण", "C) शत्रुघ्न", "D) अंगद"], answer: "C) शत्रुघ्न" },
        { question: "रामायण में किसने राम की सहायता के लिए समुद्र पर सेतु बांधा था?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) नल-नील"], answer: "D) नल-नील" },
        { question: "रामायण में किसने रावण की मृत्यु के बाद लंका का राज्य संभाला?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) अंगद"], answer: "C) विभीषण" },
        { question: "रामायण में किसने सीता की खोज के लिए राम को सहायता प्रदान की?", options: ["A) भरत", "B) लक्ष्मण", "C) हनुमान", "D) सुग्रीव"], answer: "D) सुग्रीव" },
        { question: "रामायण में किसने राम को उनकी शक्ति का स्मरण कराया था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) अंजना"], answer: "C) विभीषण" },
        { question: "रामायण में सीता का अपहरण किसने किया था?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) रावण", "D) विभीषण"], answer: "C) रावण" },
        { question: "रामायण में किसने राम को उनकी शक्ति का ज्ञान कराया था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) अंजना"], answer: "C) विभीषण" },
        { question: "रामायण में किसने राम को सीता की खोज में सहायता प्रदान की?", options: ["A) भरत", "B) लक्ष्मण", "C) हनुमान", "D) सुग्रीव"], answer: "D) सुग्रीव" },
        { question: "रामायण में किसने सीता की अग्निपरीक्षा ली थी?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) विभीषण"], answer: "A) राम" },
        { question: "रामायण में किसने रावण की नाभि में अमृत होने की बात बताई थी?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) मंदोदरी"], answer: "C) विभीषण" },
        { question: "रामायण में किसने राम को वनवास के बाद राज्याभिषेक किया था?", options: ["A) दशरथ", "B) भरत", "C) लक्ष्मण", "D) हनुमान"], answer: "B) भरत" },
        { question: "रामायण में किसने सीता की खोज के लिए हनुमान को भेजा था?", options: ["A) राम", "B) लक्ष्मण", "C) सुग्रीव", "D) विभीषण"], answer: "C) सुग्रीव" },
        { question: "रामायण में किसने सीता को अशोक वाटिका में देखा था?", options: ["A) हनुमान", "B) जटायु", "C) विभीषण", "D) कुम्भकर्ण"], answer: "A) हनुमान" },
        { question: "रामायण में किसने समुद्र पर सेतु बांधने में सहायता की थी?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) नल-नील"], answer: "D) नल-नील" },
        { question: "रामायण में किसने रावण की मृत्यु के बाद लंका का राज्य संभाला?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) अंगद"], answer: "C) विभीषण" },
        { question: "रामायण में किसने सीता की खोज में सहायता प्रदान की?", options: ["A) भरत", "B) लक्ष्मण", "C) हनुमान", "D) सुग्रीव"], answer: "D) सुग्रीव" },
        { question: "रामायण में किसने सीता की अग्निपरीक्षा ली थी?", options: ["A) राम", "B) लक्ष्मण", "C) हनुमान", "D) विभीषण"], answer: "A) राम" },
        { question: "रामायण में किसने राम को वनवास का आदेश दिया था?", options: ["A) दशरथ", "B) कौशल्या", "C) सुमित्रा", "D) कैकेयी"], answer: "D) कैकेयी" },
        { question: "रामायण में राम के वनवास के समय किसने उनकी सहायता की थी?", options: ["A) भरत", "B) लक्ष्मण", "C) शत्रुघ्न", "D) जनक"], answer: "B) लक्ष्मण" },
        { question: "रामायण में रावण के वध के बाद किसने लंका का राज्य संभाला?", options: ["A) कुम्भकर्ण", "B) मेघनाथ", "C) विभीषण", "D) अंगद"], answer: "C) विभीषण" },
    ...
    mahabharat: [
        { question: "महाभारत के रचयिता कौन हैं?", options: ["A) वाल्मीकि", "B) वेदव्यास", "C) तुलसीदास", "D) नारद"], answer: "B) वेदव्यास" },
        { question: "कौरवों के पिता का नाम क्या था?", options: ["A) पांडु", "B) धृतराष्ट्र", "C) भीष्म", "D) विदुर"], answer: "B) धृतराष्ट्र" },
        { question: "पांडवों की माता का नाम क्या था?", options: ["A) कुन्ती", "B) गांधारी", "C) द्रौपदी", "D) सुभद्रा"], answer: "A) कुन्ती" },
        { question: "कृष्ण किसके सारथी बने थे?", options: ["A) युधिष्ठिर", "B) भीम", "C) अर्जुन", "D) नकुल"], answer: "C) अर्जुन" },
        { question: "महाभारत का सबसे बड़ा योद्धा कौन था?", options: ["A) भीष्म", "B) कर्ण", "C) दुर्योधन", "D) अर्जुन"], answer: "B) कर्ण" },
        { question: "महाभारत के अनुसार, अर्जुन का पुत्र कौन था?", options: ["A) अभिमन्यु", "B) घटोत्कच", "C) नकुल", "D) सहदेव"], answer: "A) अभिमन्यु" },
        { question: "महाभारत के युद्ध में पांडवों की सेना का सेनापति कौन था?", options: ["A) द्रुपद", "B) शिखंडी", "C) धृष्टद्युम्न", "D) सत्यकी"], answer: "C) धृष्टद्युम्न" },
        { question: "महाभारत में गीता का उपदेश किसने दिया?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कृष्ण"], answer: "D) कृष्ण" },
        { question: "कौरवों की माता का नाम क्या था?", options: ["A) कुन्ती", "B) गांधारी", "C) द्रौपदी", "D) सुभद्रा"], answer: "B) गांधारी" },
        { question: "महाभारत के अनुसार, भीम का पुत्र कौन था?", options: ["A) अभिमन्यु", "B) घटोत्कच", "C) नकुल", "D) सहदेव"], answer: "B) घटोत्कच" },
        { question: "महाभारत में पांडवों के गुरु कौन थे?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कर्ण"], answer: "B) द्रोणाचार्य" },
        { question: "कौरवों की संख्या कितनी थी?", options: ["A) 100", "B) 101", "C) 105", "D) 108"], answer: "A) 100" },
        { question: "महाभारत के अनुसार, अर्जुन के गुरु कौन थे?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कर्ण"], answer: "B) द्रोणाचार्य" },
        { question: "महाभारत में पांडवों के सबसे बड़े भाई का नाम क्या था?", options: ["A) अर्जुन", "B) भीम", "C) युधिष्ठिर", "D) नकुल"], answer: "C) युधिष्ठिर" },
        { question: "महाभारत में कर्ण का रथी कौन था?", options: ["A) शल्य", "B) अश्वत्थामा", "C) दुर्योधन", "D) शकुनि"], answer: "A) शल्य" },
        { question: "महाभारत के अनुसार, अर्जुन की पत्नी का नाम क्या था?", options: ["A) द्रौपदी", "B) कुन्ती", "C) सुभद्रा", "D) उर्वशी"], answer: "C) सुभद्रा" },
        { question: "महाभारत में भीम की गदा किसने बनाई थी?", options: ["A) विश्वकर्मा", "B) द्रोणाचार्य", "C) विदुर", "D) हनुमान"], answer: "A) विश्वकर्मा" },
        { question: "महाभारत में कुरुक्षेत्र का युद्ध कितने दिनों तक चला?", options: ["A) 16 दिन", "B) 18 दिन", "C) 20 दिन", "D) 22 दिन"], answer: "B) 18 दिन" },
        { question: "महाभारत में अश्वत्थामा किसके पुत्र थे?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कर्ण"], answer: "B) द्रोणाचार्य" },
        { question: "महाभारत में भीष्म पितामह का वास्तविक नाम क्या था?", options: ["A) देवव्रत", "B) शांतनु", "C) शंतनु", "D) गंगापुत्र"], answer: "A) देवव्रत" },
        { question: "महाभारत में अर्जुन के रथ का नाम क्या था?", options: ["A) पुष्पक", "B) नंदीघोष", "C) देवदत्त", "D) महेन्द्र"], answer: "B) नंदीघोष" },
        { question: "महाभारत में द्रौपदी के पांच पतियों को क्या कहा जाता है?", options: ["A) पांडव", "B) कौरव", "C) यादव", "D) राक्षस"], answer: "A) पांडव" },
        { question: "महाभारत के अनुसार, कृष्ण का जन्म किस स्थान पर हुआ था?", options: ["A) मथुरा", "B) द्वारका", "C) गोकुल", "D) वृंदावन"], answer: "A) मथुरा" },
        { question: "महाभारत में अभिमन्यु किसके पुत्र थे?", options: ["A) युधिष्ठिर", "B) भीम", "C) अर्जुन", "D) नकुल"], answer: "C) अर्जुन" },
        { question: "महाभारत के अनुसार, किसने गीता का उपदेश अर्जुन को दिया था?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कृष्ण"], answer: "D) कृष्ण" },
        { question: "महाभारत में किसने युधिष्ठिर को जुए में हराया था?", options: ["A) दुर्योधन", "B) शकुनि", "C) कर्ण", "D) धृतराष्ट्र"], answer: "B) शकुनि" },
        { question: "महाभारत के अनुसार, कर्ण की माता का नाम क्या था?", options: ["A) कुन्ती", "B) गांधारी", "C) द्रौपदी", "D) सुभद्रा"], answer: "A) कुन्ती" },
        { question: "महाभारत में पांडवों के सबसे छोटे भाई का नाम क्या था?", options: ["A) अर्जुन", "B) भीम", "C) युधिष्ठिर", "D) सहदेव"], answer: "D) सहदेव" },
        { question: "महाभारत में अर्जुन ने भीष्म को किस दिन बाणों की शय्या पर लिटा दिया था?", options: ["A) पहले दिन", "B) चौथे दिन", "C) आठवें दिन", "D) दसवें दिन"], answer: "D) दसवें दिन" },
        { question: "महाभारत में किसने अभिमन्यु का वध किया था?", options: ["A) दुर्योधन", "B) कर्ण", "C) द्रोणाचार्य", "D) जयद्रथ"], answer: "D) जयद्रथ" },
        { question: "महाभारत में किसने द्रौपदी का चीरहरण किया था?", options: ["A) दुर्योधन", "B) दु:शासन", "C) कर्ण", "D) शकुनि"], answer: "B) दु:शासन" },
        { question: "महाभारत में युधिष्ठिर का वास्तविक नाम क्या था?", options: ["A) धर्मराज", "B) कुंतीपुत्र", "C) धर्मपुत्र", "D) अजतशत्रु"], answer: "D) अजतशत्रु" },
        { question: "महाभारत में अर्जुन का अंतिम युद्ध किसके साथ हुआ था?", options: ["A) कर्ण", "B) भीष्म", "C) द्रोणाचार्य", "D) अश्वत्थामा"], answer: "A) कर्ण" },
        { question: "महाभारत में किसने कर्ण को ब्रह्मास्त्र का ज्ञान दिया था?", options: ["A) परशुराम", "B) द्रोणाचार्य", "C) भीष्म", "D) कृष्ण"], answer: "A) परशुराम" },
        { question: "महाभारत में किसने युधिष्ठिर को सत्य का महत्व समझाया था?", options: ["A) कृष्ण", "B) विदुर", "C) भीष्म", "D) द्रोणाचार्य"], answer: "A) कृष्ण" },
        { question: "महाभारत में किसने भीष्म पितामह की मृत्यु का कारण बताया था?", options: ["A) कृष्ण", "B) अर्जुन", "C) शिखंडी", "D) द्रौपदी"], answer: "C) शिखंडी" },
        { question: "महाभारत में द्रोणाचार्य का पुत्र कौन था?", options: ["A) भीष्म", "B) दुर्योधन", "C) अश्वत्थामा", "D) कर्ण"], answer: "C) अश्वत्थामा" },
        { question: "महाभारत में किसने भीष्म को शस्त्र न उठाने की प्रतिज्ञा दिलाई थी?", options: ["A) अर्जुन", "B) युधिष्ठिर", "C) दुर्योधन", "D) कृष्ण"], answer: "D) कृष्ण" },
        { question: "महाभारत में किसने अर्जुन को चक्रव्यूह का ज्ञान दिया था?", options: ["A) कृष्ण", "B) द्रोणाचार्य", "C) भीष्म", "D) विदुर"], answer: "B) द्रोणाचार्य" },
        { question: "महाभारत में कर्ण को किसने श्राप दिया था कि वह युद्ध में अपने रथ का पहिया नहीं उठा पाएगा?", options: ["A) कुन्ती", "B) परशुराम", "C) इंद्र", "D) माता पृथ्वी"], answer: "D) माता पृथ्वी" },
        { question: "महाभारत में पांडवों का वनवास कितने वर्षों का था?", options: ["A) 10 वर्ष", "B) 12 वर्ष", "C) 14 वर्ष", "D) 15 वर्ष"], answer: "B) 12 वर्ष" },
        { question: "महाभारत में द्रौपदी का अन्य नाम क्या था?", options: ["A) याज्ञसेनी", "B) सुभद्रा", "C) कुन्ती", "D) गांधारी"], answer: "A) याज्ञसेनी" },
        { question: "महाभारत में किसने विदुर को धृतराष्ट्र का मुख्य सलाहकार बनाया था?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) पांडु", "D) कृष्ण"], answer: "A) भीष्म" },
        { question: "महाभारत में किसने युधिष्ठिर को धर्मराज की उपाधि दी थी?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) पांडु", "D) धृतराष्ट्र"], answer: "A) भीष्म" },
        { question: "महाभारत में किसने युधिष्ठिर को द्यूत क्रीड़ा के लिए आमंत्रित किया था?", options: ["A) दुर्योधन", "B) शकुनि", "C) धृतराष्ट्र", "D) विदुर"], answer: "B) शकुनि" },
        { question: "महाभारत में किसने अर्जुन को दिव्यास्त्रों का ज्ञान दिया था?", options: ["A) कृष्ण", "B) इंद्र", "C) शिव", "D) भीष्म"], answer: "B) इंद्र" },
        { question: "महाभारत में किसने भीम को गदा युद्ध की शिक्षा दी थी?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) बलराम", "D) हनुमान"], answer: "C) बलराम" },
        { question: "महाभारत में किसने अर्जुन को पाशुपतास्त्र का ज्ञान दिया था?", options: ["A) कृष्ण", "B) शिव", "C) इंद्र", "D) अग्नि"], answer: "B) शिव" },
        { question: "महाभारत में किसने कृष्ण को अपना सारथी बनाया था?", options: ["A) युधिष्ठिर", "B) भीम", "C) अर्जुन", "D) नकुल"], answer: "C) अर्जुन" },
        { question: "महाभारत में अर्जुन के दूसरे गुरु का नाम क्या था?", options: ["A) द्रोणाचार्य", "B) भीष्म", "C) कर्ण", "D) एकलव्य"], answer: "D) एकलव्य" },
        { question: "महाभारत में अर्जुन का प्रिय शस्त्र क्या था?", options: ["A) गदा", "B) तलवार", "C) धनुष", "D) भाला"], answer: "C) धनुष" },
        { question: "महाभारत में किसने युधिष्ठिर को जुए में हराने की योजना बनाई थी?", options: ["A) दुर्योधन", "B) शकुनि", "C) धृतराष्ट्र", "D) कर्ण"], answer: "B) शकुनि" },
        { question: "महाभारत में किसने अर्जुन को दिव्य चक्र सुदर्शन का ज्ञान दिया था?", options: ["A) कृष्ण", "B) शिव", "C) इंद्र", "D) अग्नि"], answer: "A) कृष्ण" },
        { question: "महाभारत में किसने अर्जुन को अभिमन्यु के चक्रव्यूह में प्रवेश करने का ज्ञान दिया था?", options: ["A) कृष्ण", "B) द्रोणाचार्य", "C) भीष्म", "D) विदुर"], answer: "B) द्रोणाचार्य" },
        { question: "महाभारत में किसने अर्जुन को दिव्यास्त्रों का ज्ञान दिया था?", options: ["A) कृष्ण", "B) इंद्र", "C) शिव", "D) भीष्म"], answer: "B) इंद्र" },
        { question: "महाभारत में किसने अर्जुन को गीता का उपदेश दिया था?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) कृष्ण"], answer: "D) कृष्ण" },
        { question: "महाभारत में अर्जुन का धनुष का नाम क्या था?", options: ["A) गांडीव", "B) पिनाक", "C) शारंग", "D) अजग"], answer: "A) गांडीव" },
        { question: "महाभारत में भीष्म पितामह का दूसरा नाम क्या था?", options: ["A) शांतनु", "B) गंगापुत्र", "C) देवव्रत", "D) शंतनु"], answer: "C) देवव्रत" },
        { question: "महाभारत में किसने युधिष्ठिर को धर्मराज कहा था?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) विदुर", "D) धृतराष्ट्र"], answer: "A) भीष्म" },
        { question: "महाभारत में किसने अर्जुन को दिव्यास्त्रों का ज्ञान दिया था?", options: ["A) कृष्ण", "B) इंद्र", "C) शिव", "D) भीष्म"], answer: "B) इंद्र" },
        { question: "महाभारत में किसने अर्जुन को दिव्य चक्र सुदर्शन का ज्ञान दिया था?", options: ["A) कृष्ण", "B) शिव", "C) इंद्र", "D) अग्नि"], answer: "A) कृष्ण" },
        { question: "महाभारत में किसने अर्जुन को पाशुपतास्त्र का ज्ञान दिया था?", options: ["A) कृष्ण", "B) शिव", "C) इंद्र", "D) अग्नि"], answer: "B) शिव" },
        { question: "महाभारत में अर्जुन का प्रिय शस्त्र क्या था?", options: ["A) गदा", "B) तलवार", "C) धनुष", "D) भाला"], answer: "C) धनुष" },
        { question: "महाभारत में किसने युधिष्ठिर को जुए में हराया था?", options: ["A) दुर्योधन", "B) शकुनि", "C) धृतराष्ट्र", "D) कर्ण"], answer: "B) शकुनि" },
        { question: "महाभारत में किसने युधिष्ठिर को द्यूत क्रीड़ा के लिए आमंत्रित किया था?", options: ["A) दुर्योधन", "B) शकुनि", "C) धृतराष्ट्र", "D) विदुर"], answer: "B) शकुनि" },
        { question: "महाभारत में किसने अर्जुन को अभिमन्यु के चक्रव्यूह में प्रवेश करने का ज्ञान दिया था?", options: ["A) कृष्ण", "B) द्रोणाचार्य", "C) भीष्म", "D) विदुर"], answer: "B) द्रोणाचार्य" },
        { question: "महाभारत में किसने युधिष्ठिर को सत्य का महत्व समझाया था?", options: ["A) कृष्ण", "B) विदुर", "C) भीष्म", "D) द्रोणाचार्य"], answer: "A) कृष्ण" },
        { question: "महाभारत में किसने युधिष्ठिर को धर्मराज की उपाधि दी थी?", options: ["A) भीष्म", "B) द्रोणाचार्य", "C) पांडु", "D) धृतराष्ट्र"], answer: "A) भीष्म" },
